    ...
    , _runningUnitTests     (unitTesting)
{
    ...
    if (_runningUnitTests) {
        // We don't want unit tests to use the same QSettings space as the normal app.
        applicationName = QStringLiteral("MyGCS_unittest");
    } else {
        // Set custom application name instead of "QGroundControl Daily"
        applicationName = QStringLiteral("Aerobotz");
    }

    setApplicationName(applicationName);
    setOrganizationName(QStringLiteral("MyCompany"));         // Optional: your org name
    setOrganizationDomain(QStringLiteral("mygcs.org"));       // Optional: your domain
